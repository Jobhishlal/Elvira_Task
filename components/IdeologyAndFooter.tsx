  ...
  return (
    <div className="bg-white">
      ...
      <section className="relative py-20 px-6 md:px-20 overflow-hidden">
       ...
       <footer className="relative bg-black text-white pt-40 pb-12 px-6 md:px-20 mt-20">
        ...
        <div className="absolute top-0 left-1/2 -translate-x-1/2 -translate-y-[80%] w-[90%] max-w-4xl bg-[#facc15] rounded-[40px] p-8 md:p-14 shadow-2xl z-30">
